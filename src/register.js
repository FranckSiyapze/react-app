        ...
        return(
            <div className="tt">
                ...
                {/* <div className={"login-container"}>
                    <form data-v-218c26d9 className="el-form login-form sigup-form el-form--label-left ">
                        <div data-v-218c26d9 className="title-container">
                            <div data-v-218c26d9 className="logo">
                            <img data-v-218c26d9 src={logo} alt=""/>
                            </div>
                        </div>
                    </form>
                </div> */}
...
<option value="Zimbabwe">Zimbabwe</option>
  ...
  <option data-countryCode="ZW" value="263">Zimbabwe (+263)</option>
            ...
            <div class="col-sm-12 form-group mb-0">
               <button className="btn btn-lg  my-2 my-sm-1 rounded-button p-3" type="submit" style={{marginLeft:"38%"}}>Create a merchant account
                                </button>
            </div>
